...
import glob # Multi-file loadingimport os
import json
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
...
# Correct Base Directory for saving models and data loading
...
# Save model - Corrected Paths
dump(ensemble, os.path.join(MODEL_DIR, "ensemble_model.joblib")) # Saves to src/model/
dump(scaler, os.path.join(MODEL_DIR, "scaler.joblib"))
dump(le, os.path.join(MODEL_DIR, "label_encoder.joblib"))
print(f"\nEnsemble model saved: {MODEL_DIR}/ensemble_model.joblib")
